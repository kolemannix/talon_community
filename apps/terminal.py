...
keymap = {
    ...
    "teemux": Key("ctrl-a"),
    "go vertical": [Key("ctrl-a"), "|"],
    "go horizontal": [Key("ctrl-a"), "-"],
    "go up": [Key("ctrl-a"), "k"],
    "go down": [Key("ctrl-a"), "j"],
    "go left": [Key("ctrl-a"), "h"],
    "go right": [Key("ctrl-a"), "l"],
    "go next": [Key("ctrl-a"), "n"],
    "go max": [Key("ctrl-a"), "z"],
    "go new": [Key("ctrl-a"), "c"],
    "teemux scroll": [Key("ctrl-a"), "a"],
    "SBT": "sbt ",
    # "tee mucks": "tmux ",
    # "T hello": "tmux ",
    # "T mux list": "tmux ls",
